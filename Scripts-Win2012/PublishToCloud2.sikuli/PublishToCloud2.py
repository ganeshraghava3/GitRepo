...
sleep(2)
JDKPath = "C:\\Program Files\\Java\\jdk1.6.0_25"
paste(JDKPath)
sleep(2)
click("1411984634578.png")
wait("1411984707247.png",10)
click("1412072640453.png")
sleep(2)
click("1412072735816.png")
sleep(1)
type("a" + Key.ENTER)
sleep(2)
...
sleep(2)
serverPath = "C:\\EclipseAzureJDT\\JavaServers\\jetty-distribution-9.1.0.v20131115\\jetty-distribution-9.1.0.v2013111510"
paste(serverPath)
sleep(2)
